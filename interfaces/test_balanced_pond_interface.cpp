...
void test_submit(BalancedThreadPond& pond) 
{
...
void test_submit_in_batch(BalancedThreadPond& pond) 
{
...
void test_task_overflow() 
{
    ...
    BalancedThreadPond pond(10, 100); 
...
void test_other_interface(BalancedThreadPond& pond, uint thread_numb) 
{
...
int main() 
{
    stream.print(util::title("Test BalancedThreadPond", 10));
